window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/monkiFestvalKnitted.png', // replace with path to image extracted from catalog layout
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: 'img/boyfriendT-ShirtWithBohemianPrint.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/boyfriendT-ShirtWithParisPrint.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/levisJeans.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/withPatchworkCrochet.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Green'],
    sizes: ['UK 19'],
    thumbnail: 'img/knittedJumper.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: 'img/onlySkinnyJeans.png',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/turtleNeckJumperInRib.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: 'img/onlyBustedKneeJean.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/colourBlock.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: 'img/oversizedCardigan.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/paul&JoeSisterJumperWithNeonTrims.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    id: 'cfd82ebb-e244-584e-ccc1-3ff1b538b28e',
    dateAdded: '2016-03-05T15:45:45.000Z',
    title: 'Wool pullover for women',
    description: 'Our ever popular crew neck jumper is an absolute classic that will never date. Made from the finest merino wool blended with 20% cashmere for luxury you can afford to wear every day.',
    discountedPrice: 125.25,
    price: 125.25,
    hasNew: false,
    category: 'women',
    fashion: 'Casual style',
    colors: ['Brown', 'White'],
    sizes: ['UK 19', 'UK 18', 'UK 17'],
    thumbnail: 'img/whitePullover.png',
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}];
